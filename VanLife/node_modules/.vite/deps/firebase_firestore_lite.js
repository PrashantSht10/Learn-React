...
(function() {
  ...
  h.j = function(f) {
    ...
    for (d = 0; d < this.g.length; d++) for (var e = 0; e < f.g.length; e++) {
      var g2 = this.i(d) >>> 16, b2 = this.i(d) & 65535, r = f.i(e) >>> 16, E2 = f.i(e) & 65535;
      c[2 * d + 2 * e] += b2 * E2;
      G2(c, 2 * d + 2 * e);
      c[2 * d + 2 * e + 1] += g2 * E2;
      G2(c, 2 * d + 2 * e + 1);
...
var BasePath = class _BasePath {
  ...
  static compareSegments(t, e) {
    ...
    return r && !n ? -1 : !r && n ? 1 : r && n ? _BasePath.extractNumericId(t).compare(_BasePath.extractNumericId(e)) : (
      // both non-numeric
      t < e ? -1 : t > e ? 1 : 0
    );
  }
...
(k = x || (x = {}))[k.OK = 0] = "OK", k[k.CANCELLED = 1] = "CANCELLED", k[k.UNKNOWN = 2] = "UNKNOWN", k[k.INVALID_ARGUMENT = 3] = "INVALID_ARGUMENT", k[k.DEADLINE_EXCEEDED = 4] = "DEADLINE_EXCEEDED", k[k.NOT_FOUND = 5] = "NOT_FOUND", k[k.ALREADY_EXISTS = 6] = "ALREADY_EXISTS", k[k.PERMISSION_DENIED = 7] = "PERMISSION_DENIED", k[k.UNAUTHENTICATED = 16] = "UNAUTHENTICATED", k[k.RESOURCE_EXHAUSTED = 8] = "RESOURCE_EXHAUSTED", k[k.FAILED_PRECONDITION = 9] = "FAILED_PRECONDITION", k[k.ABORTED = 10] = "ABORTED", k[k.OUT_OF_RANGE = 11] = "OUT_OF_RANGE", k[k.UNIMPLEMENTED = 12] = "UNIMPLEMENTED", k[k.INTERNAL = 13] = "INTERNAL", k[k.UNAVAILABLE = 14] = "UNAVAILABLE", k[k.DATA_LOSS = 15] = "DATA_LOSS";
...
var __PRIVATE_ExponentialBackoff = class {
  constructor(t, e, r = 1e3, n = 1.5, i = 6e4) {
    this.L = t, this.timerId = e, this.M = r, this.k = n, this.U = i, this.j = 0, this.W = null, /** The last backoff attempt, as epoch milliseconds. */
